...
function leaflet(args, content) {
  ...
  var model = {
    ...
    baseLayer: options.baseLayer || hexo.config.leaflet.baseLayer || 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
    attribution: options.attribution || hexo.config.leaflet.attribution || 'Map data © <a href="https://openstreetmap.org">OpenStreetMap</a> contributors.',
